...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo;  <a href="{{url('admin/navs')}}">全部网站导航</a>
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/navs/'.$field->nav_id)}}" method="post">
            <table class="add_tab">
                ...
                <tr>
                    <th>导航名称：</th>
                    <td>
                        <input type="text" name="nav_name" value="{{$field->nav_name}}"> <input type="text" name="nav_alias" value="{{$field->nav_alias}}">
