				...
				<ul>
					<li>
						...
						<ul class="sub_menu">
							...
							<li><a href="<?php echo e(url('admin/links')); ?>" target="main"><i class="fa fa-fw fa-navicon"></i>友情链接列表</a></li>
							<li><a href="<?php echo e(url('admin/navs/create')); ?>" target="main"><i class="fa fa-fw fa-plus-square"></i>添加网站导航</a></li>
							<li><a href="<?php echo e(url('admin/navs')); ?>" target="main"><i class="fa fa-fw fa-list-ul"></i>网站导航列表</a></li>
						</ul>
					</li>
					<li>
						<h3><i class="fa fa-fw fa-cog"></i>系统设置</h3>
						<ul class="sub_menu">
							<li><a href="<?php echo e(url('admin/config/create')); ?>" target="main"><i class="fa fa-fw fa-cubes"></i>添加配置</a></li>
							<li><a href="<?php echo e(url('admin/config')); ?>" target="main"><i class="fa fa-fw fa-cubes"></i>网站配置</a></li>
